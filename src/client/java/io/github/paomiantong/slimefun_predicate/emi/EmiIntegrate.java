...
import io.github.paomiantong.slimefun_predicate.emi.handler.AlchimiaVitaeHandler;
...
public class EmiIntegrate implements EmiPlugin {
    ...
    public void register(EmiRegistry registry) {
        ...
        registry.addRecipeHandler(SlimefunScreenHandlerType.DIVINE_ALTAR, new AlchimiaVitaeHandler("AV_DIVINE_ALTAR"));
        registry.addRecipeHandler(SlimefunScreenHandlerType.ORNATE_CAULDRON, new AlchimiaVitaeHandler("AV_ORNATE_CAULDRON"));
        registry.addRecipeHandler(SlimefunScreenHandlerType.ALTAR_OF_INFUSION, new AlchimiaVitaeHandler("AV_ALTAR_OF_INFUSION"));
    }
}
